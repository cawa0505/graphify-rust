...
- THEN it SHALL load a local ONNX model `all-MiniLM-L6-v2` via CPU-bound matrix bindings
- AND output dense vectors of exactly `384` dimensions for local indexing without network requests.
