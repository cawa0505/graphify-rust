...
fn draw_ui(f: &mut ratatui::Frame, app: &mut App) {
    ...
    // 3. Status Bar 狀態列繪製 (根據選定的分頁呈現不同快速鍵提示)
    let status_line = match app.active_tab {
        ActiveTab::Explorer => Line::from(vec![
            Span::styled(" <Tab>: Switch View ", Style::default().bg(Color::Gray).fg(Color::Black)),
            Span::raw(" | "),
            Span::styled(" <j/k>: Nav List ", Style::default().bg(Color::DarkGray).fg(Color::White)),
            Span::raw(" | "),
            Span::styled(" </>: Filter ", Style::default().bg(Color::Cyan).fg(Color::Black)),
            Span::raw(" | "),
            Span::styled(" <t>: BFS Trace ", Style::default().bg(Color::Magenta).fg(Color::White)),
            Span::raw(" | "),
        ...
        ActiveTab::VisualGraph => Line::from(vec![
            Span::styled(" <Tab>: Switch View ", Style::default().bg(Color::Gray).fg(Color::Black)),
            Span::raw(" | "),
            Span::styled(" <hjkl>: Pan Canvas ", Style::default().bg(Color::DarkGray).fg(Color::White)),
            Span::raw(" | "),
            Span::styled(" <+/->: Zoom ", Style::default().bg(Color::Cyan).fg(Color::Black)),
            Span::raw(" | "),
            Span::styled(" <r>: Reset ", Style::default().bg(Color::Yellow).fg(Color::Black)),
            Span::raw(" | "),
            Span::styled(" Click Node on Canvas! ", Style::default().bg(Color::Blue).fg(Color::White)),
            Span::raw(" | "),
            Span::styled(" <t>: BFS Trace ", Style::default().bg(Color::Magenta).fg(Color::White)),
            Span::raw(" | "),
            Span::styled(" <q>: Quit ", Style::default().bg(Color::Red).fg(Color::White)),
